...
class AdminLamaranMagangController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                'status' => ['sometimes', 'required', Rule::in(['pending', 'diterima', 'ditolak', 'interview', 'proses'])],
            ...
            $lamaran->update($validator->validated());
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal mengupdate lamaran',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function setInterview(Request $request, $id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal mengatur jadwal interview',
                'error' => $e->getMessage()
            ], 500);
        }
    }
    ...
    public function terima(Request $request, $id)
    {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Gagal menerima lamaran',
                'error' => $e->getMessage()
            ], 500);
        }
    }
